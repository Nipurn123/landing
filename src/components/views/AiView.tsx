      ...
      <div className="max-w-[1200px] mx-auto min-h-screen flex relative">
        ...
        <div id="md-content" className="w-full max-w-4xl mx-auto px-4 sm:px-8 md:px-16 py-12 sm:py-16 md:py-20 space-y-8 sm:space-y-10 md:space-y-12">
          ...
          <section className="space-y-6">
            <h1 
              onClick={goHome}
              className="text-base tracking-widest uppercase mb-4 cursor-pointer hover:opacity-80 transition-opacity w-fit"
              style={{ color: '#ffffff' }}
            >
              100XPROMPT
            </h1>
            ...
            <div className="space-y-2">
              <p className="text-[#888]">For Enterprise | Government | Developers</p>
              <h2 className="text-2xl font-bold" style={{ color: '#ffffff' }}># India's full-stack sovereign AI platform</h2>
          ...
          {/* MISSION */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-lg font-bold" style={{ color: '#ffffff' }}># Built from a belief, not a business plan.</h2>
            
            <div className="space-y-6">
              <div className="space-y-2">
                <h3 className="text-base font-semibold" style={{ color: '#4aab6d' }}>## The Problem: A Question That Changed Everything</h3>
                <Paragraph>Why does India's AI infrastructure run on foreign clouds? Why do our enterprises send their most sensitive data abroad just to get intelligent answers? We knew there had to be a better way.</Paragraph>
                <Quote>"Sovereignty isn't a feature. It's the only way we build."</Quote>
              </div>

              <div className="space-y-2">
                <h3 className="text-base font-semibold" style={{ color: '#4aab6d' }}>## The Vision: Bharat's Sovereign AI Backbone</h3>
                ...
                <Quote>"India's data belongs to India. We're just making that technically possible."</Quote>
              </div>
            </div>
          </section>
          ...
          {/* ARCHITECTURE */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-lg font-bold" style={{ color: '#ffffff' }}># The Sovereign Stack</h2>
            <Paragraph>Three layers. Complete control. Zero leakage.</Paragraph>
            
            <div className="space-y-6">
              <div className="space-y-2">
                <h3 className="text-base font-semibold" style={{ color: '#ffffff' }}>## Layer 1 — 100X Code (Software)</h3>
              ...
              <div className="space-y-2">
                <h3 className="text-base font-semibold" style={{ color: '#ffffff' }}>## Layer 2 — The Brain (LLM)</h3>
              ...
              <div className="space-y-2">
                <h3 className="text-base font-semibold" style={{ color: '#ffffff' }}>## Layer 3 — The Servers (Infrastructure)</h3>
          ...
          {/* MODELS */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-lg font-bold" style={{ color: '#ffffff' }}># Sovereign Models</h2>
            
            <div className="space-y-8">
              <div className="space-y-3">
                <h3 className="text-base font-semibold" style={{ color: '#ffffff' }}>## 100X Prompt Pro — Flagship LLM</h3>
              ...
              <div className="space-y-3">
                <h3 className="text-base font-semibold" style={{ color: '#ffffff' }}>## 100X Prompt Flash — Lightweight LLM</h3>
          ...
          {/* HOW WE BUILD */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-lg font-bold" style={{ color: '#ffffff' }}># How We Build Sovereign Models</h2>
            
            <div className="space-y-4">
              <div className="space-y-1">
                <h3 className="text-base font-semibold" style={{ color: '#4aab6d' }}>### 1. Purged — Clean Foundation</h3>
                <Paragraph>Removed all harmful, biased, and non-Indian compliance data from base model. DPDP-ready from day one.</Paragraph>
              </div>
              <div className="space-y-1">
                <h3 className="text-base font-semibold" style={{ color: '#4aab6d' }}>### 2. Fine-Tuned — Your Domain</h3>
                <Paragraph>Trained on your proprietary enterprise data. Legal. Finance. Medical. Yours. Sovereign intelligence.</Paragraph>
              </div>
              <div className="space-y-1">
                <h3 className="text-base font-semibold" style={{ color: '#4aab6d' }}>### 3. FP8 Quantized — Efficient Power</h3>
          ...
          {/* PRICING */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-lg font-bold" style={{ color: '#ffffff' }}># Invest in Sovereignty</h2>
            <Paragraph>No hidden fees. No data leakage. No vendor lock-in. Custom pricing tailored to your enterprise needs.</Paragraph>
            
            <div className="space-y-6">
              <div className="space-y-2">
                <h3 className="text-base font-semibold" style={{ color: '#ffffff' }}>## Flash — Speed-first inference</h3>
              ...
              <div className="space-y-2">
                <h3 className="text-base font-semibold" style={{ color: '#ffffff' }}>## Pro — Enterprise intelligence <span className="text-[#4aab6d]">(Most Popular)</span></h3>
              ...
              <div className="space-y-2">
                <h3 className="text-base font-semibold" style={{ color: '#ffffff' }}>## Enterprise — Sovereign infrastructure</h3>
          ...
          {/* TESTIMONIALS */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-lg font-bold" style={{ color: '#ffffff' }}># Trusted Across Bharat</h2>
            <Paragraph>Real stories from real users building India's AI future</Paragraph>
            
            <div className="space-y-4">
              <div className="space-y-1 pl-4 border-l border-[#333]">
                <Paragraph>"The conversational AI understood my mother tongue perfectly. For the first time, technology feels like it was built for us, not adapted for us."</Paragraph>
              ...
              <div className="space-y-1 pl-4 border-l border-[#333]">
                <Paragraph>"My grandmother can now access government services in Bhojpuri. This is what Digital India should feel like."</Paragraph>
          ...
          {/* SECURITY */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-lg font-bold" style={{ color: '#ffffff' }}># Enterprise-grade Security</h2>
          ...
          {/* RESOURCES */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-white text-sm tracking-widest uppercase">RESOURCES</h2>
            <div className="space-y-1">
          ...
          {/* LEGAL */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-sm tracking-widest uppercase" style={{ color: '#ffffff' }}>LEGAL</h2>
            <div className="space-y-1">
          ...
          {/* CTA */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-lg font-bold" style={{ color: '#ffffff' }}>Ready to own your AI infrastructure?</h2>
            <p className="text-[#666] text-sm leading-relaxed">Sovereign, secure, and scaled for India.</p>
          ...
          {/* CONTACT */}
          <section className="space-y-6 pt-8 border-t border-[#222]">
            <h2 className="text-sm tracking-widest uppercase" style={{ color: '#ffffff' }}>CONTACT</h2>
            <div className="space-y-1">
