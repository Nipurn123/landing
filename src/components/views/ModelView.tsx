...
const specs = [
  { label: "Base Model", value: "GLM-5 (Zhipu AI)" },
  { label: "Quantization", value: "FP8 Flash Attention 3" },
  { label: "Context Window", value: "128K tokens" },
  { label: "Active Parameters", value: "~30B (MoE)" },
  { label: "Deployment", value: "SGLang / vLLM" },
  { label: "Compliance", value: "Global Privacy Standards" },
  { label: "Latency", value: "<800ms first token @ H100" },
];

export default function ModelView() {
  return (
    <MainLayout>
      <Seo pageKey="model" breadcrumbs={NAVIGATION_BREADCRUMBS.model} schema={proModelSchema} />
      <main className="pt-32 md:pt-40 pb-16 md:pb-24 px-6 md:px-12 max-w-[1400px] mx-auto relative z-10 w-full flex-grow flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        >
          ...
          >
            100X Prompt Pro <br/>
            <span className="text-[hsl(var(--color-primary))]">Sovereign Intelligence</span>
          </h1>
          
          <p className="text-[clamp(1.1rem,1.8vw,1.5rem)] leading-[1.35] text-[hsl(var(--color-text-secondary))] mb-12 max-w-xl font-body">
            Built on GLM-5 - the <span className="text-[hsl(var(--color-primary))] font-medium">#1 open-source model</span> by human preference. Running inside your building.
          </p>
